...
export default function TutorPending(){
   ...
   const [pendingRequests, setPendingRequests] = useState([]);
       ...
       const fetchPendingRequests = async () => {
           try {
               setLoading(true);
               console.log('Fetching pending requests for:', currentUser.email, 'Category: Tutor');
               
               // Fetch pending requests for current user and category
               const response = await GetPendings(currentUser.email, 'Tutor');
       ...
       useEffect(() => {
           if (currentUser && currentUser.category === "Tutor") {
